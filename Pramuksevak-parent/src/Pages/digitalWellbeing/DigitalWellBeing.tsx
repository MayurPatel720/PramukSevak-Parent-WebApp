...
const DigitalWellbeingPage = () => {
	...
	const appPieData = topApps.map((app) => ({
		...
		value: app.minutes,
		percentage: (
			(app.minutes / topApps.reduce((sum, a) => sum + a.minutes, 0)) *
			100
		).toFixed(1),
	}));
	...
	const changeFromYesterday =
		today.totalScreenTime - wellbeingData.days[yesterdayIndex].totalScreenTime;
	const percentChange = (
								...
								<div className="flex items-center justify-between">
									<div>
										<p className="text-2xl font-bold text-gray-900">
											{Math.abs(changeFromYesterday)} min
										</p>
										<p className="text-sm text-gray-500">
											{changeFromYesterday > 0 ? "increase" : "decrease"}
										</p>
									</div>
									<div
										...
										<div className="flex items-start gap-2">
											...
											<div>
												...
												<p className="text-xs text-gray-600 mt-1">
													You spent {formatTime(mostUsedApp.minutes)} on{" "}
													{mostUsedApp.name} this week
												</p>
											</div>
										</div>
									</div>
									...
									<div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
										<div className="flex items-start gap-2">
											...
											<div>
												...
												<p className="text-xs text-gray-600 mt-1">
													Your highest screen time was{" "}
													{formatTime(peakDay.totalScreenTime)} on{" "}
									...
									<div className="p-3 bg-green-50 rounded-lg border border-green-100">
										<div className="flex items-start gap-2">
											...
											<div>
												...
												<p className="text-xs text-gray-600 mt-1">
													Your lowest screen time was{" "}
													{formatTime(leastDay.totalScreenTime)} on{" "}
													{formatDate(leastDay.date)}
												</p>
											</div>
										</div>
									</div>
									...
									<div className="p-3 bg-amber-50 rounded-lg border border-amber-100">
										<div className="flex items-start gap-2">
											...
											<div>
												...
												<p className="text-xs text-gray-600 mt-1">
													You unlock your phone about {weeklyUnlockAvg} times
													per day
												</p>
											</div>
										</div>
							...
							<div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-4 shadow-sm border border-purple-100">
								...
								<ul className="space-y-2 text-xs text-gray-700">
									<li className="flex items-start gap-2">
										...
										<span>
											Try setting app timers for {mostUsedApp.name} to reduce
											usage
										</span>
									</li>
									<li className="flex items-start gap-2">
									...
									<li className="flex items-start gap-2">
										<span className="text-purple-600 font-bold">•</span>
										<span>
											Reduce phone unlocks by checking notifications less
											frequently
										</span>
									</li>
								</ul>
